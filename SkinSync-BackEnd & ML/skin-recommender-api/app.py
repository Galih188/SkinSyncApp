...
app.config['JWT_SECRET_KEY'] = os.environ.get('JWT_SECRET_KEY', 'default-super-secret-for-local-dev')
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'default-another-secret-for-local-dev')
